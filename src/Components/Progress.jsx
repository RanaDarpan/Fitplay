...
//         setNotification(""); // Clear notification on toggle
...
//     setProgress(updatedPlan);
//     setNotification(""); // Clear notification on completion
...
//                             disabled={day.completed || day.exercises.length === 0}
//                             className={`${
//                               day.completed
...
//                             } py-1 px-3 rounded`}
//                           >
//                             {day.completed ? "Completed✅" : "❌ Complete Day"}
//                           </button>
//                         ) : (
